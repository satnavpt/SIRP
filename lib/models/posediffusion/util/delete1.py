...
def compute_ATE(translation1, translation2):
    if isinstance(translation1, torch.Tensor):
        translation1 = translation1.cpu().detach().numpy()
    if isinstance(translation2, torch.Tensor):
        translation2 = translation2.cpu().detach().numpy()

    d = distance_matrix(translation1, translation2)

    return np.trace(d)/(translation1.shape[0])