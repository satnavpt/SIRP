...
# PoseDiffusion options
_CN.CHKPT = None
_CN.MODEL_PARAMS = CN()
_CN.MODEL_PARAMS._target_ = None
_CN.MODEL_PARAMS.pose_encoding_type = None
_CN.MODEL_PARAMS.IMAGE_FEATURE_EXTRACTOR = CN()
_CN.MODEL_PARAMS.IMAGE_FEATURE_EXTRACTOR._target_ = None
_CN.MODEL_PARAMS.IMAGE_FEATURE_EXTRACTOR.freeze = None
_CN.MODEL_PARAMS.DENOISER = CN()
_CN.MODEL_PARAMS.DENOISER._target_ = None
_CN.MODEL_PARAMS.DENOISER.TRANSFORMER = CN()
_CN.MODEL_PARAMS.DENOISER.TRANSFORMER._target_ = None
_CN.MODEL_PARAMS.DENOISER.TRANSFORMER.d_model = None
_CN.MODEL_PARAMS.DENOISER.TRANSFORMER.nhead = None
_CN.MODEL_PARAMS.DENOISER.TRANSFORMER.dim_feedforward = None
_CN.MODEL_PARAMS.DENOISER.TRANSFORMER.num_encoder_layers = None
_CN.MODEL_PARAMS.DENOISER.TRANSFORMER.dropout = None
_CN.MODEL_PARAMS.DENOISER.TRANSFORMER.batch_first = None
_CN.MODEL_PARAMS.DENOISER.TRANSFORMER.norm_first = None
_CN.MODEL_PARAMS.DIFFUSER = CN()
...
_CN.GGS.learning_rate = None
_CN.GGS.iter_num = None
